...
class TodayTotalWorkoutDuration extends StatefulWidget {
  const TodayTotalWorkoutDuration({super.key});

  @override
  State<TodayTotalWorkoutDuration> createState() =>
      _TodayTotalWorkoutDurationState();
}

class _TodayTotalWorkoutDurationState extends State<TodayTotalWorkoutDuration> {
  @override
